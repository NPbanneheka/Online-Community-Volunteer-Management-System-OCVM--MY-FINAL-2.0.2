        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrganizationName = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventRegistrations_VolunteerEventId_UserId",
                table: "EventRegistrations",
                columns: new[] { "VolunteerEventId", "UserId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRatings_EventId_FromUserId_ToUserId",
                table: "UserRatings",
