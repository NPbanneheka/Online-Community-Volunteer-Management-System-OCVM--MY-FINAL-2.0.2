        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewText = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HelpRequests_UserProfiles_UserProfileId",
                        column: x => x.UserProfileId,
                        principalTable: "UserProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VolunteerEvents_UserProfiles_OrganizerProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PostComments_CommunityPosts_CommunityPostId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    VolunteerEventId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EventRegistrations_VolunteerEvents_VolunteerEventId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventRegistrations_VolunteerEventId",
                table: "EventRegistrations",
                column: "VolunteerEventId");

            migrationBuilder.CreateIndex(
                name: "IX_HelpRequests_UserProfileId",
                table: "HelpRequests",
                column: "UserProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostComments_CommunityPostId",
                table: "PostComments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VolunteerEvents_OrganizerProfileId",
